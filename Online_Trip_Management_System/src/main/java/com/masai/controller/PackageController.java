...
public class PackageController {
	...
	public ResponseEntity<Package> createpackage(@RequestBody Package p,@PathVariable ("key") String key ) throws PackageException{
	...
	public ResponseEntity<Package> deletePackageById(@PathVariable("id")Integer id, @PathVariable("key")String key) throws PackageException{
	...
	public ResponseEntity<PackageDto> bookpackage(@PathVariable("id")Integer id,@PathVariable("key")String key) throws PackageException{
	...
	public ResponseEntity<String> removePackage(@PathVariable("id")Integer id,@PathVariable("key")String key) throws PackageException{
